...
-- changeset WKSP_QCAADEMO23AI:1766134435560 stripComments:false  logicalFilePath:ords/wksp_qcaademo23ai/ords.sql
-- sqlcl_snapshot {"hash":"e21fdf54d87c35b3e4b8ff2240ca357aba506c65","type":"ORDS_SCHEMA","name":"ords","schemaName":"WKSP_QCAADEMO23AI","sxml":""}
--
...
BEGIN
  ORDS.ENABLE_SCHEMA(
      ...
      p_url_mapping_pattern => 'qcaa_demo_23ai',
...
exception
 ...
 when others then 
  ...
  ORDS.CREATE_ROLE(
      p_role_name=> 'oracle.dbtools.role.autorest.WKSP_QCAADEMO23AI');
  ORDS.CREATE_ROLE(
      p_role_name=> 'oracle.dbtools.role.autorest.any.WKSP_QCAADEMO23AI');
  l_roles(1) := 'oracle.dbtools.autorest.any.schema';
  l_roles(2) := 'oracle.dbtools.role.autorest.WKSP_QCAADEMO23AI';

  ORDS.DEFINE_PRIVILEGE(
      p_privilege_name => 'oracle.dbtools.autorest.privilege.WKSP_QCAADEMO23AI',
      p_roles          => l_roles,
      p_patterns       => l_patterns,
      p_modules        => l_modules,
      p_label          => 'WKSP_QCAADEMO23AI metadata-catalog access',
      p_description    => 'Provides access to the metadata catalog of the objects in the WKSP_QCAADEMO23AI schema.',
      p_comments       => NULL); 
